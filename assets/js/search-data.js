    ...
    handler: () => {
      window.location.href = "/al-folio/";
        ...
        handler: () => {
          ...
          description: "",
          section: "News",},{id: "news-attended-and-presented-poster-at-uncertainty-in-artificial-intelligence-uai-conference-rank-a-in-rio-brazil",
          title: 'Attended and presented poster at Uncertainty in Artificial Intelligence (UAI) Conference (Rank A*)...',
          description: "",
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%68%61%72%69%70%72%69%79%61%61%68%61%72%69%6B%75%6D%61%72@%67%6D%61%69%6C.%63%6F%6D", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/haripriyaaharikumar# your GitHub user name", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/haripriya-harikumar# your LinkedIn user name", "_blank");
        },
      },{
        id: 'social-scholar',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=50ErN80AAAAJ", "_blank");
        },
      },{
      id: 'light-theme',
